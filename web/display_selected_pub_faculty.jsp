    ...
    <body>
        ...
        <div>
            <center>
                ...
                %>
                <tr>
                  <td><form method="post" action="publication_checkout_form_faculty.jsp?pub_id=<%= pub_id%>"><input type="submit" value="Checkout Publication"></form></td>
                  <td><form method="post" action="renew_publication_faculty.jsp?pub_id=<%= pub_id%>"><input type="submit" value="Renew"></form></td>
                    <td><form method="post" action="e_copy_checkout_faculty.jsp?pub_id=<%= pub_id%>"><input type="submit" value="Checkout E-copy"></form></td>
                </tr>
                <tr>
