               ...
               <div>
                ...
                %>    
                    <tr>
                        ...
                        <td><a href="reserve_room_faculty.jsp?lib_id=<%= rs.getString(1)%>&room_no=<%= rs.getString(2)%>&startTime=<%= startTime%>&endTime=<%= endTime%>">Reserve</a></td>
                ...
                %>
                <tr>
                    <td colspan="4"><a href="display_rooms_form_faculty.jsp">Back</a></td>
                </tr> 
            </tbody>
        </table>  
