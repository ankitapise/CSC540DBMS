    ...
    <body>
        ...
        <div>
            <center>
                ...
                %>
                <tr>
                    <td colspan="2"><form method="post" action="reserve_camera_form_faculty.jsp?cam_id=<%= cam_id%>"><input type="submit" value="Reserve"></form></td>
                </tr>
                </tr>
                <tr>
                    <td colspan="3"><a href="display_cameras_faculty.jsp">Back</a></td>
                </tr> 
            </tbody>
        </table>  
            </center>
