    ...
    <body>
        ...
        <div>
            <center>
                ...
                %>
                <tr>
                    <td><form method="post" action="checkedout_pub_renew_faculty.jsp?pub_id=<%= pub_id%>"><input type="submit" value="Renew Publication"></form></td>
                </tr>
                <tr>
                    <td><a href="checkedout_publications_faculty.jsp">Back</a></td>
                </tr>
                </body>
                </table>
            </center>
